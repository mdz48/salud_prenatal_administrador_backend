...
_TEST_DB_DIR = tempfile.mkdtemp(prefix="salud_prenatal_admin_test_")
...
def app():
    import main  # importa con env de test ya seteado

    # main.py NO ejecuta create_all (el esquema es de la API principal);
    # los tests de integracion crean el esquema aqui contra SQLite.
